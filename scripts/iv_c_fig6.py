...
# -*- coding: utf-8 -*-
"""
iv_c_fig6.py — Composite tile for Fig 6 (front depth + attractor map).
"""
...
PANELS = [
    ("iv_c_fig6_panel_a.png", "iv_c_fig6_panel_a.py"),
    ("iv_c_fig6_panel_b.png", "iv_c_fig6_panel_b.py"),
]
...
def main():
    ...
    fig.tight_layout()
    pdf = FIG_DIR / "iv_c_fig6.pdf"
    png = FIG_DIR / "iv_c_fig6.png"
