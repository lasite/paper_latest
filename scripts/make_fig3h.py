"""make_fig3h.py — Panel (h): θ kymograph, steady_front regime."""
import os, sys, numpy as np
_HERE = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, _HERE)

from fig3_data import panel_data_kymo, draw_theta_kymo, PANEL_LETTERS
...
def render():
    ...
    draw_theta_kymo(ax, d["t"], d["x"], d["Z"], fig, cax)
